...
// ErrNotFound is returned when a welcome config is not found in database.
...
func (r *WelcomeRepo) Get(ctx context.Context, guildID int64) (*model.WelcomeConfig, error) {
...
func (r *WelcomeRepo) Upsert(ctx context.Context, cfg *model.WelcomeConfig) (*model.WelcomeConfig, error) {
...
func (r *WelcomeRepo) Delete(ctx context.Context, guildID int64) error {
	return r.db.WithContext(ctx).
		Where("guild_id = ?", guildID).
		Delete(&model.WelcomeConfig{}).Error
}
